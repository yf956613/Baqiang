...
public class CouldDeleteListView extends ListView {

    private static final String TAG = "CouldDeleteListView";
    ...
    public CouldDeleteListView(Context context, AttributeSet attrs) {
        super(context, attrs);
